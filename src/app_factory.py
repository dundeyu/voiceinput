...
DEFAULT_LOCAL_ASR_MODEL_PATH = Path("models/FunAudioLLM/Fun-ASR-Nano-2512")
...
def build_runtime(config: dict, project_root: Path, status_callback=None):
    ...
    def resolve_local_default_model_path(default_path: Path) -> Path | None:
    ...
    model_path = (
        resolve_project_path(model_config.get("path"))
